...
Loopbiotic sends the selected context to the backend configured by the user.
...
Managed `loopbioticd` binaries are downloaded from versioned GitHub releases and are

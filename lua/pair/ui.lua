...
function M.setup_highlights()
  local highlights = {
    PairNormal = { link = "NormalFloat" },
    PairBorder = { link = "FloatBorder" },
    PairTitle = { link = "Title" },
    PairMuted = { link = "Comment" },
    PairAction = { link = "Special" },
    PairGoal = { link = "Identifier" },
  }
...
function M.float(lines, opts)
  ...
  vim.wo[win].winhighlight = opts.winhighlight or "NormalFloat:PairNormal,FloatBorder:PairBorder"
